...
begin
  ...
  values
    ...
    (target_user_id, 'In Work', 'In Work Agent', 'gpt-5.6-luna', 'Implement the approved change in the configured repository on a new branch. Run relevant checks and summarize changes and risks.' || context_suffix, '', '', ''),
